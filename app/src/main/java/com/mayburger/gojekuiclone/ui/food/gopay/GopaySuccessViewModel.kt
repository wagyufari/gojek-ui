...
import kotlinx.android.synthetic.main.fragment_gopay_success.*
import java.lang.Exception


class GopaySuccessViewModel @ViewModelInject constructor(
    dataManager: DataManager,
    schedulerProvider: SchedulerProvider
) :
    BaseViewModel<GopaySuccessNavigator>(dataManager, schedulerProvider) {
    override fun onEvent(obj: Any) {
        when (obj) {
            is BackEvent -> {
                if (obj.obj is GopaySuccessFragment) {
    ...
    companion object {
        fun GopaySuccessFragment.playSuccessAnimation() {
