...
import com.mayburger.gojekuiclone.databinding.FragmentGojekChatBinding
import com.mayburger.gojekuiclone.ui.base.BaseFragment
import com.mayburger.gojekuiclone.util.ext.sheetBehavior
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.android.synthetic.main.fragment_gojek_chat.*

@AndroidEntryPoint
class GojekChatFragment : BaseFragment<FragmentGojekChatBinding, GojekChatViewModel>(),
    GojekChatNavigator {

    override val bindingVariable: Int
        get() = BR.viewModel
    override val layoutId: Int
        get() = R.layout.fragment_gojek_chat
    override val viewModel: GojekChatViewModel by viewModels()
